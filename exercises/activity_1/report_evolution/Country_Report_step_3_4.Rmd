...
The average life expectancy in `r params$country` between 1980 and 2010 was `r average_lifeExp$average_lifeExp`. The minimum life expectancy in `r params$country` between 1980 and 2010 was `r min_lifeExp$min_lifeExp`. The maximum life expectancy in `r params$country` between 1980 and 2010 was `r max_lifeExp$max_lifeExp`. 
...
The data comes from the [gapminder](http://www.gapminder.org/data/){target="_blank"} dataset from the [`gapminder` package](https://github.com/jennybc/gapminder) by Jenny Bryan.